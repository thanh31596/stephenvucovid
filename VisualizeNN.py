...
class NeuralNetwork():
    ...
    def draw(self, weights_list=None):
        ...
        overlaphandler = TextOverlappingHandler(            self.number_of_neurons_in_widest_layer*horizontal_distance_between_neurons,            len(self.layers)*vertical_distance_between_layers, grid_size=0.2 )

        pyplot.figure(figsize=(1200, 800))
        ...
        pyplot.axis('scaled')
        pyplot.axis('off')
        pyplot.title( 'Models', fontsize=15 )
